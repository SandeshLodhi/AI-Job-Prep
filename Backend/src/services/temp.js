...
about writing clean code, designing REST APIs, and delivering
...
I am a MERN stack developer with around 3 years of experience, primarily
focused on backend development using Node.js and MongoDB. I have worked
on building REST APIs, implementing authentication using JWT, and
optimizing database queries.

I enjoy solving system design problems and improving application
performance. Recently, I have been exploring AI integrations using the
Gemini API and learning scalable backend architecture. I also have basic
experience with Redis and Docker, though I haven't used them extensively
in production.

I am currently targeting backend developer roles where I can contribute
to building scalable systems while continuing to strengthen my expertise
in distributed systems, performance optimization, and cloud-native
development.
`;
